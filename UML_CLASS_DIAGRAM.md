...
stateDiagram-v2
    ...
    生成乘法练习题 --> 主菜单: 完成/返回
    生成混合练习题 --> 主菜单: 完成/返回
    生成标准练习题 --> 交互练习: 6 (使用当前题目集)
    生成加法练习题 --> 交互练习: 6 (使用当前题目集)
    生成减法练习题 --> 交互练习: 6 (使用当前题目集)
    生成乘法练习题 --> 交互练习: 6 (使用当前题目集)
    生成混合练习题 --> 交互练习: 6 (使用当前题目集)
...
| 状态 | 说明 | 可转换到 |
|------|------|---------|
| `主菜单` | 主界面，等待用户选择 | 各生成功能、交互练习、退出 |
| `生成X练习题` | 生成指定类型题目 | 主菜单、交互练习 |
| `交互练习` | 进行口算练习 | 显示结果、退出练习 |
| `显示结果` | 展示练习统计 | 主菜单、重新练习 |
| `退出系统` | 结束程序 | - |
...
| 当前状态 | 条件 | 下一状态 |
|---------|------|---------|
| 主菜单 | choice == 1-5 | 对应的生成功能 |
| 主菜单 | choice == 6 | 交互练习 |
| 主菜单 | choice == 7 | 退出系统 |
| 生成功能 | 完成/返回 | 主菜单 |
| 生成功能 | choice == 6 | 交互练习（使用已生成题目） |
| 交互练习 | 所有题目完成 | 练习完成 |
| 交互练习 | 用户输入'q' | 退出练习 |
| 练习完成 | 返回 | 主菜单 |
| 练习完成 | 重新练习 | 交互练习 |